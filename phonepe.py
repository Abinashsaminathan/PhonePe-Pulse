...
Original file is located at
    https://colab.research.google.com/drive/1VMdxDl50D1ZiVqyucqAFOuWN4jZQ2T4u
"""
...
connection = pymysql.connect(host='localhost', user='root', password='abinash@9216', database='phonepe_pulse',port=3307)
...
cursor.execute("SELECT * FROM phonepe_pulse.d__phonepe_pulse_gg_trans")
...
if SELECT == "Home":
    ...
    with col2:
        st.video(
            "C:\\Users\\morle\\Downloads\\PhonePe_bike_insurance_ah_verum_1.50_roobaiku_perunga.__VJ32fT89sJI_247.webm")

    st.subheader(':blue[Registered Users Hotspots - States]')

    Data_Aggregated_Transaction_df = pd.read_csv(
        r'C:\phonepe\Phonepe_Pulse_Data_Visualization/Data_Aggregated_Transaction_Table.csv')
    Data_Aggregated_User_Summary_df = pd.read_csv(
        r'C:\phonepe\Phonepe_Pulse_Data_Visualization/Data_Aggregated_User_Summary_Table.csv')
    ...
    Scatter_Geo_Dataset = pd.read_csv(
        r'C:\phonepe\Phonepe_Pulse_Data_Visualization/Data_Map_Districts_Longitude_Latitude.csv')
...
if SELECT == "Contact":
    name = "Abinash Saminathan"
    mail = (f'{"Mail :"}  {"abinash9216@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {

        "GITHUB": "https://github.com/Abinashsaminathan",
        "LINKEDIN": "https://www.linkedin.com/in/abinash-saminathan-081151257/"}
...
cursor.execute("ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password BY 'abinash@9216'")
